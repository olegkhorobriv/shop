    ...
    <div class="container">
        <div class="user__inner">
            ...
            for($i = 0; $i < count($result); $i++){
                $out .= '<div class="bas__inner-box">';
                $out .= '<ul>';
                $out .= '<li>Імя<span>'.$result[$i]['name'].'</span></li>';
                $out .= '<li>Прізвище<span>'.$result[$i]['surname'].'</span></li>';
                $out .= '<li>Телефон<span>'.$result[$i]['phone'].'</span></li>';
                $out .= '<li>Адреса<span>'.$result[$i]['address'].'</span></li>';
                $out .= '<li>Назва товару<span>'.$result[$i]['namep'].'</span></li>';
                $out .= '<li>Ціна<span>'.$result[$i]['price'].'</span></li>';
                $out .= '<li>Колір<span>'.$result[$i]['color'].'</span></li>';
                $out .= '<li>Розмір<span>'.$result[$i]['sizepro'].'</span></li>';
                $out .= '<li>ID продукту<span>'.$result[$i]['id'].'</span></li>';

                $out .= '</ul>';
                $out .= '<div class="bas__inner-img">';
                $out .= '<li><img src="'.$result[$i]['foto'].'" alt=""></li>';
                $out .= '</div>';
                $out .= '</div>';
            }
            echo $out;
