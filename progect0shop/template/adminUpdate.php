...
//    $img5 = $_POST['img5'];
    ...
    $pu = adminUpdate($id, $name, $price, $description, $min_description, $size, $size2, $size3, $size4, $color, $color2, $color3, $img1, $img2, $img3, $img4, $img5, $search, $date, $categoryA);
    if ($pu) {
...
//                    $out .= '<p>Короткий опис товару <input type="text" name="title" value="'.$result[$i]['min_description'].'"></p>';
                ...
                <!--                        <option value="Бюстгальтер" >Бюстгальтер</option>-->
                <!--                        <option value="Трусики" >Трусики</option>-->
