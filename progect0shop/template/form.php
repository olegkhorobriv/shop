...
if(isset($_POST['submit'])){
    ...
    $purchase = purchaseUser($ip, $name, $surname, $phone, $address);

    $out = '';
    $out .='<div class="err" style="text-align: center">';
    $out .= 'Дякуємо за замовлення';
    $out .='</div>';
        ...
        <div class="login_inner">
            <form action="" method="post">
                <div class="login_inner-box">
                    ...
                    <div class="login_inner-text">Номер телефону</div>
                    <input type="text"  name="phone" placeholder="Введіть данні" required>
                    <div class="login_inner-text">Адреса доставки</div>
                    <input type="text"  name="address" placeholder="Введіть данні" required>
                ...
                <div class="login-input">
                    <input type="submit" value="Оформити" name="submit">
                </div>
