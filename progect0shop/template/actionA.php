...
if (isset($_POST['create'])) {
    ...
    $create = adminActionCriate($name, $price, $description, $min_description, $size, $size2, $size3, $size4, $color, $color2, $color3, $img1, $img2, $img3, $img4, $img5, $search, $date,$categoryA);
    if ($create) {
